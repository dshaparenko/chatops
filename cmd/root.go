...
var slackOptions = bot.SlackOptions{
	...
	WaitingApprovalMessage: envGet("SLACK_WAITING_APPROVAL_MESSAGE", "waiting for approval").(string),
...
func Execute() {
	...
	flags.StringVar(&slackOptions.WaitingApprovalMessage, "slack-waiting-approval-message", slackOptions.WaitingApprovalMessage, "Slack waiting approval message")
